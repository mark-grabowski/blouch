...
#include "stanExports_blouchOU_reg_direct_postpc.h"

RCPP_MODULE(stan_fit4blouchOU_reg_direct_postpc_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_blouchOU_reg_direct_postpc")
