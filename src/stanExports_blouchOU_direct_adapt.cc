...
#include "stanExports_blouchOU_direct_adapt.h"

RCPP_MODULE(stan_fit4blouchOU_direct_adapt_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_blouchOU_direct_adapt")
