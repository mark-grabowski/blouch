...
#include "stanExports_Dalec_analysis_impute.h"

RCPP_MODULE(stan_fit4Dalec_analysis_impute_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Dalec_analysis_impute")
