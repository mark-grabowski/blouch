...
#include "stanExports_blouchMigAdpt_VE.h"

RCPP_MODULE(stan_fit4blouchMigAdpt_VE_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_blouchMigAdpt_VE")
