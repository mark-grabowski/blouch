...
generated quantities {
  ...
  L_Rho = lkj_corr_cholesky_rng(1+Z_direct+Z_adaptive,4);
  ...
  for(i in 1:n_reg){
    for(j in 1:(1+Z_direct+Z_adaptive)){
  ...
  pred_X = calc_mixed_dmX(a,T_term,X_sim,Z_direct,Z_adaptive);//Given measurement error in X variable, uncomment this statement
