...
transformed parameters{
  ...
  matrix[N,Z_direct+Z_adaptive] pred_X = calc_mixed_dmX(a,T_term,X,Z_direct,Z_adaptive);//Given measurement error in X variable, uncomment this nested statement
