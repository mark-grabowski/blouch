//Basic model - estimates single optima and single slope
...
parameters {
  ...
  real beta;           // Slope
  vector<lower=0.00001>[N] es;    // Evolvability/selection
  vector<lower=0.00001>[N] sd_theta; // Standard deviations for optima deviations
...
transformed parameters {
  ...
  // Construct A - population-specific es
  for (i in 1:N) {
