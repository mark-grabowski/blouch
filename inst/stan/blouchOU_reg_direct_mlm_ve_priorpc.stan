...
data {
  ...
  array[N] int reg_tips; //Vector of number of nodes per lineage
  vector[2] hl_prior;
  real vy_prior;
...
generated quantities {
  ...
  for(i in 1:N){
    mu[i] = optima_matrix[i,]*optima+X_sim[i,]*beta[reg_tips[i],]';//Given measurement error in X variable, uncomment this statement
    }
