...
transformed parameters{
  ...
  matrix[n_reg,(1+Z_direct)] v = (diag_pre_multiply(sigma, L_Rho) * Z)';
  matrix[n_reg,Z_direct] beta = beta_bar + v[, 2:(Z_direct+1)];
...
generated quantities {
  ...
  real u_i;
  vector[N] log_lik;
  corr_matrix [(1+Z_direct)] Rho = multiply_lower_tri_self_transpose(L_Rho);
