---
title: "Empirical Example from Grabowski (in revision) Walkthrough"
author: "Mark Grabowski"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Empirical Example from Grabowski (in revision) Walkthrough}
...
This example presents the basic and advanced options of *Blouch* and the code below is the complete analysis of the empirical example from Grabowski (in revision) on antler size and breeding group evolution.
...
First, load the tree from Tsuboi et al. (2024) and the dataset. Original ata from Tsuboi et al. (2024) is available at DRYAD:
https://doi.org/10.5061/dryad.kh18932dt, and dataset including breeding group regims is included in the *Blouch* package.
```{r Load_data}
########################################################################################################
set.seed(10)
