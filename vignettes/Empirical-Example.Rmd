...
This is the Empirical Example from Grabowski (in revision) using data from Tsuboi et al. (2024) available at DRYAD:
https://doi.org/10.5061/dryad.kh18932dt, which the presents basic and advanced options of *Blouch*
