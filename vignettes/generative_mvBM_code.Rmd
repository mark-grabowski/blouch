---
title: "Generative mvBM Script"
output: html_notebook
editor_options: 
  chunk_output_type: console
---
########################################################################################################################
Generate BM data with known parameter values and then use to test mvBlouchBM stan code
```{r}
rm(list=ls())
library(MASS)
library(rstan)
...
#Same as:
C<-vcv(phy) #This function computes the expected variances and covariances of a continuous trait assuming it evolves under a given model - Brownian



```

Simulate X data - R[1,2] and [2,1] = 0
```{r}
n_traits <-2
...
R_true <- matrix(c(0.1,0.0, #Known R matrix
              0.0,0.5),
